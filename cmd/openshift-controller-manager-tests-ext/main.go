...
import (
	...
	// The import below is necessary to ensure that the openshift controller manager tests are registered with the extension.
	_ "github.com/openshift/openshift-controller-manager/test/extended"
)

func main() {
	registry := e.NewRegistry()
	ext := e.NewExtension("openshift", "payload", "openshift-controller-manager")

	// Suite: conformance/parallel (fast, parallel-safe)
	ext.AddSuite(e.Suite{
		Name:    "openshift/openshift-controller-manager/conformance/parallel",
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/openshift-controller-manager/conformance/serial",
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/openshift-controller-manager/optional/slow",
	...
	ext.AddSuite(e.Suite{
		Name: "openshift/openshift-controller-manager/all",
	})
	...
	root := &cobra.Command{
		Long: "OpenShift Controller Manager Tests Extension",
	}
